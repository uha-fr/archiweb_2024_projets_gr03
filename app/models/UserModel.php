...
class UserModel extends Model
{
    ...
    public function insertUser($username, $password, $email, $firstname, $lastname, $sexe){
        if (!$this->isUsernameFound($username) && !$this->isEmailFound($email)) {

            $query = 'INSERT INTO users (username, password, email, firstname, lastname, sexe) VALUES (:username, :password, :email, :firstname, :lastname, :sexe)';
            $stmt = $this->db->prepare($query);
