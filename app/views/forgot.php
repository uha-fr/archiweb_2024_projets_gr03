    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <?php if (!isset($_GET["token"])): ?>
            ...
            <form class="space-y-6" action="reset" method="POST">
                ...
                <div>
                    <button type="submit" class="flex w-full justify-center rounded-md bg-[#93BE76] px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-[#C6E0B9] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#C6E0B9]">Sign in</button>
                </div>
            </form>
