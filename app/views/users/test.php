                ...
                <nav x-bind:class="! open ? 'w-0' : 'w-[280px]'"
                    ...
                    <div class="flex flex-wrap items-center px-4">
                        ...
                        <div class="px-2">
                            ...
                            <h2 class="text-lg font-medium dark:text-gray-300 ">John Doe</h2>
                        </div>
                    </div>
                    <div class="pb-6 mt-4 overflow-x-hidden overflow-y-auto">
                        <ul class="mb-8 text-sm">
                            <li>
                                <a href="#"
                                    class="flex items-center px-6 py-4 text-gray-700 dark:text-gray-400 group dark:hover:bg-gray-700 hover:bg-gray-100">
                            ...
                            <li x-data="{ open: false }">
                                <a href="#" @click="open = ! open"
                                    class="flex items-center px-6 py-4 text-gray-700 group dark:text-gray-400 dark:hover:bg-gray-700 hover:bg-gray-100">
                                    <span class="inline-block mr-3">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="relative text-left lg:inline-block" x-data="{ open: false }">
                                    ...
                                    <div x-show="open" id="dropdown_profile"
                                        class="absolute right-0 w-48 mt-3 origin-top-right bg-white rounded shadow dark:bg-gray-800 dark:text-gray-100 dark:bg-gray-700"
                                        style="display: none;">
                                        <div class="py-1">
                                            <a href="#"
