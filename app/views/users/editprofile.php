...
<div class="lg:ml-[300px] relative h-full max-h-screen rounded-xl transition-all duration-200 bg-white py-3 px-3 md:py-5 md:px-20">
    ...
    <div class="flex flex-wrap items-center justify-between mb-10 space-y-3">
        <div class="left flex items-center">
            <img class="rounded-full h-32 w-32 mr-5 p-1 object-cover	 ring-2 ring-gray-300 dark:ring-gray-500" src="<?php echo IMG_LOAD . '/profile/' . $userDetails["image"]?>" alt="">
...
<div id="accordion-arrow-icon" data-accordion="open" class="py-5">
